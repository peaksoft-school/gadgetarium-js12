...
export { default as IconCertificate } from './icon-сertificate.tsx';
...
export {default as IconKamore} from './icon-kamera.tsx'
export {default as IconCashUponReceipt} from './icon-cash-upon-receipt.tsx'
export {default as IconUponReceipt} from './icon-upon-receipt.tsx'
