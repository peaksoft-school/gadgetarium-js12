...
const OrderDelivered = () => {
  ...
  const processingOrders = adminOrders?.filter(order => order.status === 'Доставлены') || [];
          ...
          <div className={scss.content_left}>
            <div className={scss.content_left_1}>
              ...
              <div className={scss.navigation_div}>
                ...
                <Link to={""}>
                  <h3 className={scss.active_link}>Доставлены{statusCounts['Доставлены'] > 0 ? ` (${statusCounts['Доставлены']})` : ''}</h3>
                </Link>
