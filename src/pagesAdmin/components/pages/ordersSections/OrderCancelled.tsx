...
const OrderCancelled = () => {
  ...
  const processingOrders = adminOrders?.filter(order => order.status === 'Отменены') || [];
          ...
          <div className={scss.content_left}>
            <div className={scss.content_left_1}>
              ...
              <div className={scss.navigation_div}>
                ...
                <Link to={""}>
                  <h3 className={scss.active_link}>Отменены{statusCounts['Отменены'] > 0 ? ` (${statusCounts['Отменены']})` : ''}</h3>
                </Link>
              </div>
