...
const Order = () => {
  ...
  const processingOrders = adminOrders?.filter(order => order.status === 'В обработке') || [];
          ...
          <div className={scss.content_left}>
            <div className={scss.content_left_1}>
              ...
              <div className={scss.navigation_div}>
                ...
                <Link to={""}>
                  <h3 className={scss.active_link}>В обработке{statusCounts['В обработке'] > 0 ? ` (${statusCounts['В обработке']})` : ''}</h3>
                </Link>
                <Link to={"/admin/orders/courier-on-the-way"}>
                  <h3>Курьер в пути{statusCounts['Курьер в пути'] > 0 ? ` (${statusCounts['Курьер в пути']})` : ''}</h3>
                </Link>
