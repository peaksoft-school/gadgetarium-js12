...
const OrderInPending = () => {
  ...
  const processingOrders = adminOrders?.filter(order => order.status === 'В ожидании') || [];
          ...
          <div className={scss.content_left}>
            <div className={scss.content_left_1}>
              ...
              <div className={scss.navigation_div}>
                <Link to={""}>
                  <h3 className={scss.active_link}>В ожидании{statusCounts['В ожидании'] > 0 ? ` (${statusCounts['В ожидании']})` : ''}
                  </h3>
                </Link>
