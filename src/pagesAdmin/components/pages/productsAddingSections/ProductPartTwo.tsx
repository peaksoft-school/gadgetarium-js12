...
import { useGetNewProductsQuery, usePatchNewProductsQueryMutation } from "@/src/redux/api/productAddingPartTwo"
        ...
        <div className={scss.content}>
          <div className={scss.page_content_1}>
            <p className={scss.navigation_p}>
              <Link to={"/admin"}><p>Товары »</p></Link> <h3>Установка цены и количества товара</h3>
            </p>
            ...
            <div className={scss.full_table_div}>
              <div className={scss.table_div}>
                <div className={scss.col_one}>
                  <p className={scss.brand_e}>Бренд</p>
                  <p className={scss.colour_e}>Цвет</p>
                  <p className={scss.gb_e}>Объем памяти</p>
                  <p className={scss.ram_e}>Оперативная память</p>
                  <p className={scss.simm_e}>Кол-во SIM-карт</p>
                  <p>Дата выпуска</p>
                </div>
