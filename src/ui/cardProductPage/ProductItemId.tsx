...
export const ProductItemId = () => {
	...
	// const [_, setItemIdImage] = useState();
	// const [_, setOpenModal] = useState();
	const { productId } = useParams();
  const {data} = useGetProductsItemIdQuery(productId!);
  const handleSliderResultsForward = () => {
		if (slider) {
			setSlider2(true);
			setSlider(false);
			setSlider4(false);
						...
						<div className={scss.productPhotoDiv}>
							...
							<div className={scss.divphotos}>
								<img
									...
									onClick={handleSliderResultsBack}
									src="logo"
									alt="logo"
								/>
								<div
								...
								<img
									...
									onClick={handleSliderResultsForward}
									src="logo"
									alt="logo"
								/>
							</div>
