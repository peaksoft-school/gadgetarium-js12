...
const Slider = () => {
  ...
  return (
    <div className={scss.slider}>
          ...
          <div className={item.className}>
            <div className={scss.background}>
              <div className={scss.content}>
                ...
                <img className={scss.pink_vector} src={item.vector} alt="pinkVectorSvg" />
                <img className={scss.iphoneImg} src={item.image} alt="iPhoneImage" />
              </div>
            </div>
          </div>
        ))}
      ...
      {loaded && instanceRef.current && instanceRef.current.track.details && instanceRef.current.track.details.slides && (
