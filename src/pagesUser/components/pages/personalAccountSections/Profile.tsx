      ...
      <div className="container">
        <div className={scss.content}>
          <div className={scss.page_content_1}>
            <p className={scss.navigation_p}>Личный кабинет » <h3>Учетная запись</h3></p>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  {profiles.map((e) => (
                    <div className={scss.fields}>
                      ...
                      <div><p>{errors?.[e.error]?.message?.toString()}</p></div>
                  ...
                  <div className={scss.address_input}>
                    ...
                    <div><p>{errors?.address?.message?.toString()}</p></div>
                  </div>
                    ...
                    <div className={scss.password_buttons}>
                      {passwords.map((e) => (
                        <div className={scss.password_fields}>
                          <label>{e.label} <span>*</span></label>
                          <input
                            type={passwordVisibility[e.error] ? "text" : "password"}
                            placeholder={e.placeholder}
                          ...
                          {passwordVisibility[e.error] ? (
                            <IconEye onClick={() => setPasswordVisibility(prevState => ({ ...prevState, [e.error]: false }))} />
                          ) : (
                            <IconEyeOff onClick={() => setPasswordVisibility(prevState => ({ ...prevState, [e.error]: true }))} />
                          )}
                  ...
                  <div className={scss.buttons}>
                    <button type="button" className={scss.back_button}>Назад</button>
