					...
					{data?.length === 0 ? (
						...
						<div className={scss.container_products_favorite}>
							...
							<div className={scss.container_products}>
								{isLoading ? (
									<>
										<div className={scss.favorite_skeleton}>
											<Skeleton.Button
												active
												block
												style={{ width: 275, height: 442 }}
											/>
											<Skeleton.Button
												active
												block
												style={{ width: 275, height: 440 }}
											/>
											<Skeleton.Button
												active
												block
													...
													<div className={scss.content_product}>
														<div
															className={
																...
																item.recommend === true
																	? `${scss.product_basket_and_favorite_buttons_and_photo} ${scss.active_product_basket_and_favorite_buttons_and_photo}`
														...
														<div className={scss.products_name_and_rating}>
															<p className={scss.text_stock}>
																В наличии ({item.price})
															</p>
