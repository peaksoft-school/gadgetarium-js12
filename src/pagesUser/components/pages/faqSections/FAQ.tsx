...
const faqData = [
	{
		...
		answer: [
			...
			'	Помимо этого, мы также предоставляем удобные варианты доставки в городе Бишкек и регионах. В городе доставка стоит 200 сомов, но при покупке свыше 10 000 сомов она бесплатно.',
