								...
								<div className={scss.small_texts}>
									<ul>
										...
										<li>
											...
											партнерами и предлагаем отличные цены и эксклюзивные
										...
										<li>
											&#8226; Мы обеспечиваем оперативную доставку по всей
											стране, чтобы вы могли как можно скорее наслаждаться
											покупкой.
										</li>
										<li>
										...
										<li>
											&#8226; Мы регулярно обновляем наш каталог, добавляя
											новинки и следя за последними тенденциями в мире
											технологий.
										</li>
									</ul>
								</div>
