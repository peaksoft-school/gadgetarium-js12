							...
							<div className={scss.texts}>
								...
								<div className={scss.we_today}>
									<div className={scss.maps_texts}>
										...
										<ul>
											<li>
												<strong>Профессиональная команда:</strong> Мы собрали
												слаженную команду экспертов, увлеченных своей работой.
												Наши сотрудники не только отлично разбираются в
												современных технологиях, но и готовы всегда помочь нашим
												клиентам, предложив оптимальные решения и
												квалифицированные консультации.
											</li>
											<li>
												<strong>Широкий ассортимент:</strong> Мы предлагаем
												огромный выбор качественной продукции ведущих мировых
												брендов, включая телефоны, ноутбуки, умные часы и многое
												другое. Это позволяет нашим клиентам находить все
												необходимые гаджеты в одном месте.
											</li>
											<li>
												<strong>Качественное обслуживание:</strong> Мы
												обеспечиваем полный послепродажный сервис, включая
												информационную и техническую поддержку. Наличие склада
												запчастей позволяет нам быстро решать любые возникшие
												проблемы и поддерживать бесперебойную работу
												оборудования.
											</li>
											<li>
												<strong>Партнерские отношения:</strong> Мы строго
												соблюдаем все обязательства перед нашими партнерами и
												предлагаем отличные цены и эксклюзивные условия для
												постоянных клиентов. Это создает доверительные и
												долгосрочные отношения.
											</li>
											<li>
												<strong>Гарантия качества:</strong> Вся наша продукция
												проходит строгий контроль качества, что обеспечивает
												надежность и долговечность приобретенных товаров.
											</li>
										</ul>
									</div>
									<img src={map} alt="map" />
