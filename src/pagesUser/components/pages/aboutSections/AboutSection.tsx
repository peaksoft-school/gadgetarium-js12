						...
						<>
							...
							<div className={scss.texts}>
								...
								<div className={scss.small_texts}>
									<li>
										&#8226; У нас вы найдете телефоны, ноутбуки, умные часы и
										многое другое от ведущих мировых брендов.
									</li>
									<li>
										&#8226; Мы обеспечиваем полный послепродажный сервис,
										включая информационную и техническую поддержку.
									</li>
									<li>
										&#8226; Для обеспечения качественного сервиса и
										бесперебойной работы оборудования у нас всегда есть в
										наличии необходимые запчасти.
									</li>
									<li>
										&#8226; Мы строго соблюдаем все обязательства перед нашими
										партнерами и предлагаем отличные цены и эксклюзивные условия
										для постоянных клиентов.
									</li>
									<li>
										&#8226; Наши сотрудники знают свое дело и ориентируются во
										всех нюансах работы с техническим оборудованием, всегда
										готовы помочь вам сделать правильный выбор.
									</li>
									<li>
										&#8226; Мы обеспечиваем оперативную доставку по всей стране,
										чтобы вы могли как можно скорее наслаждаться покупкой.
									</li>
									<li>
										&#8226; Вся продукция проходит строгий контроль качества,
										чтобы вы могли быть уверены в надежности и долговечности
										приобретенного оборудования.
									</li>
									<li>
										&#8226; Мы регулярно обновляем наш каталог, добавляя новинки
										и следя за последними тенденциями в мире технологий.
									</li>
								</div>
